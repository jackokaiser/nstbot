...
class RetinaBot(nstbot.NSTBot):
    def initialize(self):
        ...
        self.add_sensor('adc0', bit=1, range=1023, length=1)
        self.add_sensor('adc1', bit=2, range=1023, length=1)
        self.add_sensor('adc2', bit=3, range=1023, length=1)
        self.add_sensor('adc3', bit=4, range=1023, length=1)
        self.add_sensor('adc4', bit=5, range=1023, length=1)
        self.add_sensor('adc5', bit=6, range=1023, length=1)
        self.add_sensor('gyro', bit=7, range=32767, length=3)
